...
[![MCP](https://img.shields.io/badge/MCP-stdio-green?style=for-the-badge)](client-setup.zh-CN.md)
...
- 大范围编辑前的项目结构与引用关系感知
- 基于 [cwtools](https://github.com/MillenniumDawn/cwtools) 的 HOI4 语言支持
- 交付前的红/黄/绿加载风险检查
- 编码、格式和媒体规范的快速校对
...
如果想了解每个工具适合什么场景、应该按什么顺序使用，请看 [详细功能介绍](features.zh-CN.md)。客户端接入与配置示例放在 [MCP 接入指南](client-setup.zh-CN.md)。
...
Codex、Claude Code 和通用 MCP 配置示例见 [client-setup.zh-CN.md](client-setup.zh-CN.md)。
